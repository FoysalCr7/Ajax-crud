    ...
    <div class="modal fade" id="single-data" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul class="list-group">
                        <li class="list-group-item">ID: <span class="text-danger" id="id1"></span></li>
                        <li class="list-group-item">Title: <span class="text-danger" id="title1"></span> </li>
                        <li class="list-group-item">Author: <span class="text-danger" id="author1"></span></li>
                        <li class="list-group-item">POST: <span class="text-danger" id="post1"></span></li>
                    </ul>
                </div>
            </div>
        </div>
